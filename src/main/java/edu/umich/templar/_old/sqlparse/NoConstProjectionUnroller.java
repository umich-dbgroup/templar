 ...
 */
public class NoConstProjectionUnroller extends ExpressionVisitorAdapter {
    Map<String, Relation> relations;
    List<Relation> queryRelations;
    List<Projection> projections;

    public NoConstProjectionUnroller(Map<String, Relation> relations, List<Relation> queryRelations) {
