 ...
 */
public class FullPredicateUnroller extends ExpressionVisitorAdapter {
    List<Predicate> predicates;
    List<Relation> queryRelations;
    Map<String, Relation> relations;

    public FullPredicateUnroller(Map<String, Relation> relations, List<Relation> queryRelations) {
