...
import edu.umich.templar._old.qf.Limit;
...
import edu.umich.templar._old.sqlparse.*;
import edu.umich.templar._old.template.TemplateRoot;
...
public class CoverageSDSS extends CoverageHelper {
    ...
    public List<QueryFragment> fullFrag(PlainSelect ps) {
        ...
        if (ps.getFromItem() instanceof Table) {
            ...
            Relation rel = new edu.umich.templar._old.rdbms.Function(func.getFunction().getName(), "function", new HashMap<>(), new HashMap<>());
            selectQFs.add(new RelationFragment(rel));
