...
import edu.umich.templar._old.template.InstantiatedTemplate;
import edu.umich.templar._old.template.JoinPathGenerator;
import edu.umich.templar._old.template.Template;
import edu.umich.templar._old.template.Translation;
...
public class TemplarOld {
    ...
    public static void main(String[] args) {
        try {
            TemplarOld templar = new TemplarOld("127.0.0.1", 3306, "root", "mymeezsql", "advising", "um_info_extended_cleaned");
     ...
     * FUNCTIONS TO EXPOSE
     */
    public TemplarOld(String dbHost, Integer dbPort, String dbUser,
