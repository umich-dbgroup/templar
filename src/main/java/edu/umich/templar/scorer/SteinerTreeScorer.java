...
public class SteinerTreeScorer implements InterpretationScorer {
    private LogCountGraph logGraph;

    public SteinerTreeScorer(LogCountGraph logCountGraph) {
        this.logGraph = logCountGraph;
    }
