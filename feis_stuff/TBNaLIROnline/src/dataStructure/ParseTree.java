...
public class ParseTree implements Serializable
{
	...
	public boolean moveSubTree(ParseTreeNode newParent, ParseTreeNode node)
	{
		...
		if(isParent == false)
		{
			ParseTreeNode oldParent = node.parent; 
		...
		{
			ParseTreeNode nodeParent = node.parent; 
